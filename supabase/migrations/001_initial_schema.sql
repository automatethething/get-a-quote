...
CREATE TABLE IF NOT EXISTS getaquote_matches (
  ...
  vendor_tx_id TEXT UNIQUE,           -- PayRails vendor_tx_id (UUID generated by app)
  entitlement_token TEXT UNIQUE,      -- PayRails entitlement_token (proof of payment)
  payment_status TEXT DEFAULT 'pending' CHECK (payment_status IN ('pending','paid','refunded','disputed','lost')),
