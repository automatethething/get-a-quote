    ...
    if (vendor?.contact_email && user) {
      try {
        ...
        await resend.emails.send({
          from: process.env.EMAIL_FROM || "noreply@quoteveil.app",
          ...
          html: `
            <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto">
              ...
              <hr/>
              <p style="color:#9ca3af;font-size:.875rem">Platform commission: ${Math.round((match.commission_cents / match.total_cents) * 100)}% retained. QuoteVeil — quoteveil.app</p>
            </div>`,
        });
        ...
        await resend.emails.send({
          ...
          html: `
            <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto">
              ...
              <p>Questions? Email <a href="mailto:support@quoteveil.app">support@quoteveil.app</a></p>
            </div>`,
        });
